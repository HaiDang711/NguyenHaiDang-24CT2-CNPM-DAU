...
| (thêm) | **Xu hướng du lịch — tin tức tự động cập nhật** từ RSS công khai của VnExpress Du lịch (hợp pháp, có ghi nguồn) | mục "Xu hướng du lịch" trên `index.html`, API: `backend/api/news.php` |
